...
ltmle(data = ObsData, Anodes = Anodes, Lnodes = Lnodes, Ynodes = Ynodes, 
   ...
   Parameter Estimate:  68.284 
    Estimated Std Err:  0.30749 
              p-value:  <2e-16 
    95% Conf Interval: (67.681, 68.886) 
\end{Soutput}
\begin{Sinput}
...
ltmle(data = ObsData, Anodes = Anodes, Lnodes = Lnodes, Ynodes = Ynodes, 
   ...
   Parameter Estimate:  68.28 
    Estimated Std Err:  0.36789 
              p-value:  <2e-16 
    95% Conf Interval: (67.559, 69.001) 
\end{Soutput}
\begin{Sinput}
...
ltmle(data = ObsData, Anodes = Anodes, Lnodes = Lnodes, Ynodes = Ynodes, 
   ...
   Parameter Estimate:  68.28 
    Estimated Std Err:  0.30749 
              p-value:  <2e-16 
    95% Conf Interval: (67.678, 68.883) 
\end{Soutput}
\begin{Sinput}
...
ltmle(data = ObsData, Anodes = Anodes, Lnodes = Lnodes, Ynodes = Ynodes, 
   ...
   Parameter Estimate:  68.281 
    Estimated Std Err:  0.30725 
              p-value:  <2e-16 
    95% Conf Interval: (67.679, 68.884) 
\end{Soutput}
\end{Schunk}
\begin{Schunk}
\begin{Sinput}
...
ltmle(data = ObsData, Anodes = Anodes, Lnodes = Lnodes, Ynodes = Ynodes, 
   ...
   Parameter Estimate:  68.26 
    Estimated Std Err:  0.30744 
              p-value:  <2e-16 
    95% Conf Interval: (67.657, 68.862) 
\end{Soutput}
\end{Schunk}
...
Control Estimate:
   Parameter Estimate:  60.775 
    Estimated Std Err:  0.31646 
              p-value:  <2e-16 
    95% Conf Interval: (60.155, 61.395) 

Additive Treatment Effect:
   Parameter Estimate:  7.4846 
    Estimated Std Err:  0.33893 
              p-value:  <2e-16 
    95% Conf Interval: (6.8203, 8.1489) 
\end{Soutput}
\end{Schunk}
\end{solution}
